...
use App\Http\Requests\Batch\ExtraSessionRequest;
use App\Http\Requests\Batch\SessionCancelRequest;
use App\Http\Requests\Batch\StatusChangeRequest;
...
class BatchController extends Controller
{
     ...
     */
    public function BatchStatusChange(StatusChangeRequest $request, Batch $batch, UpdateService $service)
    {
        try {
    ...
    /**
     * @param ExtraSessionRequest $request
     * @param Batch $batch
     * @return \Illuminate\Http\JsonResponse
     */
    public function BatchExtraSession(ExtraSessionRequest $request, Batch $batch)
    {
        try {
            return resOk((new ExtraSession())->handle($request->all(), $batch));
        } catch (Exception $e) {
    ...
    /**
     * @param SessionCancelRequest $request
     * @param Batch $batch
     * @param StatusChangeService $service
     * @return \Illuminate\Http\JsonResponse
     */
    public function SessionCancel(SessionCancelRequest $request, Batch $batch, StatusChangeService $service)
    {
        try {
            return resOk($service->handle($request->all(), $batch));
        } catch (Exception $e) {
            return $e;
        }
    }
